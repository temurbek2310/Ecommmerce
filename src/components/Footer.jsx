                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex items-center md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Privacy Policies</h2>
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                    ...
                                    <div>
                                        <form className='flex'>
                                            <input type="email" className='text-black placeholder:text-gray-400 underline' placeholder='Enter your Email Addres' />
                                            <button className='btn text-black underline' type='sumbit'>SUBSCRBE</button>
                                        </form>
                                    </div>
                                </ul>
                            </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">2022 Meubel House. All rights reverved
                        </span>
